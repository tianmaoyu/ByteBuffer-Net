...
namespace ByteBufferTest
{
    ...
    [BtyeContract]
    public partial class UserTest : Writeable
    {
        ...
        /// 
        /// </summary>
        [ByteMember(10, ByteType.ObjectArray, "RoleTest")]
        public List<RoleTest> RoleList { get; set; }


    }

    [BtyeContract]
    public partial class RoleTest : Writeable
    {
